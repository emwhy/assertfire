...
import org.emw.assertion.string.StringBeAssertionMethods;

import java.util.regex.Pattern;

public class JsonAssertionMethods extends AssertionMethods {
    public final StringBeAssertionMethods be;
    private final @Nullable String actual;

    JsonAssertionMethods(@Nullable AssertionGroup group, @NonNull String labelForActual, @Nullable String actual, boolean negated, boolean ignoreCase) {
