...
public final class JsonBeAssertionMethods extends AssertionMethods {
    private final @Nullable String actual;

    JsonBeAssertionMethods(@Nullable AssertionGroup group, @NonNull String labelForActual, @Nullable String actual, boolean negated, boolean ignoreCase) {
